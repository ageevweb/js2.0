...
function t2() {
  fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=andrey')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t3() { 
  fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=2&num2=3')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t6() {
  fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=11&num2=10')
  .then(data => {
      return data.text();
  })
  .then(data => {
...
function t8() {
  ...
  fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1993')
  .then(data => {
      return data.text();
  })
  .then(data => {
...
function t9() {
  ...
  fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=9&year=1993&m=1&d=1&y=1')
  .then(data => {
      return data.text();
  })
  .then(data => {
...
function t11() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=andrey'
  })
  .then(data => {
      return data.text();
  })
...
function t12() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=5&num2=17'
  })
  .then(data => {
      return data.text();
  })
...
function t13() {
    ...
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=5&num2=17'
      })
      .then(data => {
          return data.text();
      })
...
function t15() {
    ...
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=5&num2=17'
      })
      .then(data => {
          return data.text();
      })
...
function t17() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1993'
      })
      .then(data => {
          return data.text();
      })
...
function t18() {
  ...
  fetch('http://getpost.itgid.info/index2.php', {
    ...
    body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=9&&m=1&d=1&y=1'
  })
  .then(data => {
      return data.text();
  })
